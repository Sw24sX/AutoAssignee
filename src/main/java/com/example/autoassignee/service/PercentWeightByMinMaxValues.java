...
public interface PercentWeightByMinMaxValues {
     ...
     * @param reviewer ревьвер, для которого необходимо вычислить итоговое значение
     * @param mergeRequest обрабатываемый merge request
     * @return вес ревьювера
     */
    Integer getCorrectWeight(WeightByNotValues weightByNotValues, Reviewer reviewer, MergeRequest mergeRequest);
